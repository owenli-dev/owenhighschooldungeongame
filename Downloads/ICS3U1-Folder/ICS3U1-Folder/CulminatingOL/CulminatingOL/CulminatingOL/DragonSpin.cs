...
namespace CulminatingOL
{
    public partial class DragonSpin : Form
    {
        ...
        public DragonSpin(int intCoins, int intVal)
        {
            ...
            intMonsters = intVal; //Set monsters count (don't add)
        ...
        private void btnTitlePage_Click(object sender, EventArgs e)
        {
            ...
            TitlePage TitlePage = new TitlePage(intSpinCoins); //Pass remaining coins back
            intIndexNumber = 0; //Resets index number
            string[] strMonsters = new string[40000000]; //resets the array
            this.Hide();
        ...
        private void btnSpinButton_Click(object sender, EventArgs e)
        {
            ...
            {
                if (intMonsters != 0) //only subtract if there is a monster
                {
        ...
        public void writeSpunMonsters()
        {
            ...
            for (int i = 0; i < intIndexNumber; i++) //Only loop through actual spun monsters
            {
